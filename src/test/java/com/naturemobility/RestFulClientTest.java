...
public class RestFulClientTest {
	...
	private static final int USER_ID_INSERT = 110;
	private static final int USER_ID_QUERY = 111;
	private static final int USER_ID_UPDATE = 112;
