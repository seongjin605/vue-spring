...
<%@ include file="/WEB-INF/views/default/css-header.jsp"%>

  <!-- Page Wrapper -->
  <div id="wrapper">
 	<%@ include file="/WEB-INF/views/default/sidebar.jsp"%>
    <!-- Content Wrapper -->
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Seongjin Park</span>
                <img class="img-profile rounded-circle" src="https://boscon.io/images/pages/partners/naturemobility/logo-large.png">
              </a>
  ...
  <%@ include file="default/js-header.jsp"%>
